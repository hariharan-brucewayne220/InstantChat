...
import com.example.covidmessergerapp.ViewFullImageActivity
...
):RecyclerView.Adapter<ChatsAdapter.ViewHolder?>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        return if(position==1){
            val view:View= LayoutInflater.from(mContext).inflate(com.example.covidmessergerapp.R.layout.message_item_right,parent,false)
            ViewHolder(view)
        }else{
            val view:View= LayoutInflater.from(mContext).inflate(com.example.covidmessergerapp.R.layout.message_item_left,parent,false)
            ViewHolder(view)
        }
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        else
        {
           ...
           if(firebaseUser!!.uid.equals(chat.getSender())){
    ...
    inner class ViewHolder(itemView: View):RecyclerView.ViewHolder(itemView){
        ...
        init{
            ...
            right_image_view=itemView.findViewById(R.id.profile_image)
