...
import com.example.covidmessergerapp.AdapterClasses.ChatsAdapter
import com.example.covidmessergerapp.Fragments.APIService
import com.example.covidmessergerapp.ModelClasses.Chat
import com.example.covidmessergerapp.ModelClasses.Users
import com.example.covidmessergerapp.Notifications.*
...
class MessageChatActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        toolbar.setNavigationOnClickListener {
            var intent= Intent(this@MessageChatActivity,WelcomeActivity::class.java)
        ...
        send_message_btn.setOnClickListener {
            ...
            if (message == "") {
                Toast.makeText(
                    this@MessageChatActivity, "please write a message,first... ",
                    Toast.LENGTH_LONG
                ).show()
            } else {
        ...
        attach_image_file.setOnClickListener {
            ...
            intent.type = "image/*"
            startActivityForResult(Intent.createChooser(intent,"Pick Images"),438)
        }
    ...
    private fun sendMessageToUser(senderId: String, receiverId: String?, message: String) {
            ...
            .setValue(messageHashMap).addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    val chatsListReference = FirebaseDatabase.getInstance()
                        ...
                        .child(userIdVisit)
                    //implement the notifcations using fcm
                    chatsListReference.addListenerForSingleValueEvent(object:ValueEventListener{
                        ...
                        override fun onDataChange(p0: DataSnapshot) {
                            ...
                            val chatsListReceiverRef = FirebaseDatabase.getInstance()
                                .reference.child("ChatList").child(userIdVisit)
        ...
        // implement the push nootification using fcm
                      ...
                      override fun onResponse(
                          ...
                          if(response.code()==200){
                              if(response.body()!!.success!==1){
                                  Toast.makeText(this@MessageChatActivity,"Faied,Nothing happen.",Toast.LENGTH_LONG).show()
                              }
                          }
                      }
