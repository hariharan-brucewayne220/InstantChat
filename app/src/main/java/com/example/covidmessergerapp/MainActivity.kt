...
import com.example.covidmessergerapp.Fragments.ChatsFragment
import com.example.covidmessergerapp.Fragments.SearchFragment
import com.example.covidmessergerapp.Fragments.SettingsFragment
            ...
            override fun onDataChange(p0: DataSnapshot) {
                if(p0.exists()){
                   val user: Users?=p0.getValue(Users::class.java)
                    ...
                    Picasso.get().load(user.getProfile()).placeholder(R.drawable.corona).into(profile_image)
                }
            }
